...
import { JobListingProps, JobDetailProps } from "@/interfaces";
...
const JobDetail: React.FC<JobDetailProps> = ({ job }) => {
  ...
  return (
    <div className="col-span-2 p-2 lg:p-20 mt-4 lg:flex flex-col gap-8 bg-white h-screen scrollbar_hidden overflow-x-hidden overflow-y-scroll">
      <div className="">
        <div onClick={() => router.back()} className="flex lg:hidden gap-4 mb-6 bg-white">
          <Image
        ...
        <h1 className="text-[25px] lg:text-[30px] font-bold text-[#56b8b5]">{job.company}</h1>
        <span className="flex flex-col gap-1">
          <p className="text-gray-600 text-[25px] lg:text-[35px] font-bold">{job.job_title}</p>
      ...
      <div>
        ...
        <h2 className="text-gray-600 text-[25px] lg:text-[35px] font-bold">Job Description</h2>
      ...
      <div>
        <h2 className="text-gray-600 text-[25px] lg:text-[35px] font-bold">About Company</h2>
        <p className="text-gray-600 lg:text-[20px] mb-8 leading-6 lg:leading-7 lg:w-[75%]">
          {job.about_company}
        </p>
      </div>
